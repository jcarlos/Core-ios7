...
//{
//    if(indexPath.row == 0) {
//        CSPhotoCell *photoCell = (CSPhotoCell *)cell;
//        
//        UIBezierPath *maskPath;
//        maskPath = [UIBezierPath bezierPathWithRoundedRect:photoCell.cellImage.bounds byRoundingCorners:UIRectCornerTopLeft cornerRadii:CGSizeMake(5.0, 5.0)];
//        CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
//        maskLayer.frame = photoCell.cellImage.bounds;
//        maskLayer.path = maskPath.CGPath;
//        photoCell.cellImage.layer.mask = maskLayer;
//        
//    } else if (indexPath.row == self.dataSource.count - 1) {
//        CSPhotoCell *photoCell = (CSPhotoCell *)cell;
//        
//        UIBezierPath *maskPath;
//        maskPath = [UIBezierPath bezierPathWithRoundedRect:photoCell.cellImage.bounds byRoundingCorners:UIRectCornerBottomLeft cornerRadii:CGSizeMake(5.0, 5.0)];
//        CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
//        maskLayer.frame = photoCell.cellImage.bounds;
//        maskLayer.path = maskPath.CGPath;
//        photoCell.cellImage.layer.mask = maskLayer;
